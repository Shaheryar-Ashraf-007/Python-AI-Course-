...
class  Student:
    def __init__(self,root):
        ...
        img = Image.open(r"F:\python course\CLASS01\Python-AI-Course-\student management system\images\student6.jpg")
        ...
        img1 = Image.open(r"F:\python course\CLASS01\Python-AI-Course-\student management system\images\student8.jpg")
        ...
        img2 = Image.open(r"F:\python course\CLASS01\Python-AI-Course-\student management system\images\student7.jpg")
        ...
        img_left = Image.open(r"F:\python course\CLASS01\Python-AI-Course-\student management system\images\student10.jpeg")
        ...
        student_label = Label(class_student_frame,text="StudentID:",font=("new times roman",12,"bold"),bg="white")
        ...
        img_right = Image.open(r"F:\python course\CLASS01\Python-AI-Course-\student management system\images\right3.webp")
                    ...
                    if conn.is_connected():
                        ...
                        query = """UPDATE face1 
                                SET Department = %s, Course = %s, Year = %s, Semester = %s, 
                                    Studentname = %s, Teacher = %s, Address = %s, Gender = %s, 
                                    Phone = %s, Email = %s 
                                WHERE Student_id = %s"""
        ...
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                if delete>0:
                    conn = mysql.connector.connect(host="localhost", username="root", password="test@123", database="student")
                    my_cursor = conn.cursor()
                    sql = "delete from face1 where Student_id = %s"
    ...
    def generate_dataset(self):
        ...
        try:
            ...
            id = len(myresult) + 1  # Increment ID based on existing records
            
            # Update database with student information
            my_cursor.execute("UPDATE face1 SET Department = %s, Course = %s, Year = %s, Semester = %s, Studentname = %s, Teacher = %s, Address = %s, Gender = %s, Phone = %s, Email = %s WHERE Student_id = %s ",
                            (self.var_dep.get(), self.var_course.get(), self.var_year.get(), self.var_sem.get(), self.var_std_name.get(), self.var_teacher.get(), self.var_address.get(), self.var_gender.get(), self.var_phone.get(), self.var_email.get(), id))
            conn.commit()
            self.fetch_data()
            self.reset_data()
            conn.close()
            
            # Get the full path to the directory containing the cascade classifier file
            cascade_file_path ="F:\\python course\\CLASS01\\Python-AI-Course-\\student management system\\haarcascade_frontalface_default.xml"
            ...
            while True:
                ...
                if face_cropped(my_frame) is not None:
                    ...
                    file_name = f"F:\\python course\\CLASS01\\Python-AI-Course-\\student management system\\data\\user.{id}.{img_id}.jpg"
